...
// the same tool name on different servers stays distinguishable.
...
export function MCPToolsetsTab({ accessToken, userRole }: MCPToolsetsTabProps) {
  ...
  const columns = toolsetColumns(isAdmin, setEditToolset, setDeleteId, proxyBaseUrl, serverPrefixById);
